  ...
  return (
    ...
    >
      ...
      <Input
        ...
        className="pl-9 pr-9 bg-background border-border hover:bg-background dark:hover:bg-accent hover:border-primary/30 focus-visible:border-primary focus-visible:ring-0 focus-visible:ring-offset-0 w-full transition-colors duration-200"
      />
      {value && (
