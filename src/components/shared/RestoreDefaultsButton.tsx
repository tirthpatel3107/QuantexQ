  ...
  return (
    <CommonTooltip content="Restore defaults">
      <Button
        ...
        className="group relative bg-white dark:bg-white/10 hover:bg-primary/10 dark:hover:bg-primary/10 hover:text-primary transition-all duration-200 border border-transparent hover:border-primary/20"
      >
