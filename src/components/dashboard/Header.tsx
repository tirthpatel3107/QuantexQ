...
export function Header() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-30 h-14 border-b border-border bg-card px-4 flex items-center justify-between backdrop-blur supports-[backdrop-filter]:bg-card/80">
      {/* Brand */}
      ...
      <div className="flex items-center gap-4">
        <div className="text-right">
          <div className="text-lg font-bold tabular-nums text-primary glow-primary">
            {formatTime(time)}
          </div>
