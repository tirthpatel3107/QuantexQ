 ...
 */
export const PageHeaderLayout = memo(function PageHeaderLayout({
  icon,
  title,
  metadata,
  actions,
  ...
  return (
    <div
      className={cn(
        "dashboard-panel shrink-0 mt-1 mb-5 p-4 flex flex-wrap items-center justify-between gap-4 z-10",
        className,
      )}
    >
