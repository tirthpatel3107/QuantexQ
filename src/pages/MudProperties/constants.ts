import { Timer, Beaker, Layers, Thermometer, FlaskConical, Ruler, BarChart3, Droplets } from "lucide-react";
...
export const MUD_OVERVIEW_CARDS = [
  {
    ...
    description: "Fluid system type, base fluid, active pits volume, flowline temperature, and rheology source.",
    icon: Timer,
  },
  {
    id: "rheology",
    title: "Rheology",
    description: "PV, YP, Gel 10s/10m — derive from viscometer or enter manually.",
    icon: Beaker,
  },
  {
    id: "density",
    title: "Density & Solids",
    description: "Oil/Water ratio, salinity, solids content, and density inputs.",
    icon: Layers,
  },
  {
    id: "temperature",
  ...
  },
  {
    id: "calibration",
    title: "Calibration",
    description: "Viscometer cal. date, density cal. date, and temperature sensor offset.",
    icon: Ruler,
  },
  {
    id: "summary",
    title: "Summary",
    description: "Read-only overview of all mud properties — mud system, PV/YP, gel, oil/water, surface/BHT.",
    icon: BarChart3,
  },
];
