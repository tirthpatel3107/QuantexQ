...
import { formatElapsedSeconds } from "@/shared/utils/date-utils";
import { appendChartPoint } from "@/pages/Dashboard/data/mockData";
import { CHART_UPDATE_INTERVAL_MS, TIMER_TICK_MS } from "@/shared/constants/config";
import {
