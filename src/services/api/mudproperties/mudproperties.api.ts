...
const fetchFluidOverviewData = async (): Promise<ApiResponse<FluidOverviewTabData>> => {
...
const fetchTemperatureData = async (): Promise<ApiResponse<TemperatureTabData>> => {
  // TODO: Uncomment when real API is ready
...
const fetchGasCompressibilityData = async (): Promise<ApiResponse<GasCompressibilityTabData>> => {
  // TODO: Uncomment when real API is ready
...
// Fluid Overview
const saveFluidOverviewData = async (payload: SaveFluidOverviewPayload): Promise<ApiResponse<SaveResult>> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
// Rheology
const saveRheologyData = async (payload: SaveRheologyPayload): Promise<ApiResponse<SaveResult>> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
// Density
const saveDensityData = async (payload: SaveDensityPayload): Promise<ApiResponse<SaveResult>> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
// Temperature
const saveTemperatureData = async (payload: SaveTemperaturePayload): Promise<ApiResponse<SaveResult>> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
export const useSaveTemperatureData = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: mudPropertiesKeys.temperature() });
      queryClient.invalidateQueries({ queryKey: mudPropertiesKeys.summary() });
    },
  });
};
...
// Gas Compressibility
const saveGasCompressibilityData = async (payload: SaveGasCompressibilityPayload): Promise<ApiResponse<SaveResult>> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
export const useSaveCalibrationData = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: mudPropertiesKeys.calibration() });
    },
  });
};
